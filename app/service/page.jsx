...
export default function Service() {
  return (
    <>
      ...
      <div className=" text-white bg-local bg-center bg-cover bg-black bg-[url('https://res.cloudinary.com/dtsllu9jj/image/upload/v1696740155/johnny/IMG_6829_wjceuv.jpg')] " id="pt">
